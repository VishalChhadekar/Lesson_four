...
{ 
    ...
    { 
        ...
        if (k > 0 && k <= r - l + 1) // 4>0 && 4<=(6-0+1) i.e. 4<7 (true)
        { 
...
int partition(int arr[], int l, int r) //array,0,6
    ...
    { 
        ...
        int pivot = (int)(Math.random()) * (n-1); //0*6 = 0 
        System.out.println("Randome value: "+ (int)(Math.random()));
